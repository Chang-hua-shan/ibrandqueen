...
const translations = {
  zh: {
    ...
    about_label: "MEET CAROLINA",
    about_title: "關於創辦人 Carolina Wu",
    about_quote: "「每個卓越的靈魂背後，都需要一個能被世界看見的品牌定位。」",
    about_desc1: "Carolina Wu 是一位深耕品牌、募資與策略談判的資深顧問。致力於協助企業家、高端主管及專業菁英在數位時代打造無可替代的個人影響力與商業高度。",
    about_desc2: "憑藉超過十年的跨界實戰經驗，她為菁英人士提供客製化的品牌定位、商業模式梳理與資源媒合服務，引領您的事業邁向跨越式的成長。",
    skill_1: "連續創業家",
    skill_2: "品牌、募資、策略談判顧問",
    skill_3: "高管轉職諮詢",
    skill_4: "",
    ...
    modal_close: "關閉視窗",
    mockup_name: "創辦人 Carolina",
    mockup_title: "Founder & Chief Consultant",
    mockup_badge: "Carolina's Wonderland",
    mockup_hint: "觸碰或點擊探索",
    btn_website: "進入官方網站",
    btn_vcard: "儲存至電話簿",
    quick_call: "撥號",
  ...
  en: {
    ...
    about_label: "MEET CAROLINA",
    about_title: "About Carolina Wu",
    about_quote: "“Behind every extraordinary soul lies a brand positioning that deserves to be seen by the world.”",
    about_desc1: "Carolina Wu is an experienced advisor in branding, fundraising, and strategic negotiation, dedicated to helping founders and executives build personal authority and commercial influence.",
    about_desc2: "With over a decade of cross-industry entrepreneurial experience, she provides tailored positioning, business model strategy, and premium networking matchmaking to trigger leapfrog growth.",
    skill_1: "Serial Entrepreneur",
    skill_2: "Branding, Fundraising & Strategic Negotiation Advisor",
    skill_3: "Executive Career Transition Consultant",
    skill_4: "",
    services_label: "EXPERT SERVICES",
    ...
    address_value: "5F., No. 118, Sec. 2, Zhongxiao E. Rd., Zhongzheng Dist., Taipei City",
